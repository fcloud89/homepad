...
class fRoundCheckBox extends StatefulWidget {
  const fRoundCheckBox({
    Key? key,
    this.isChecked,
    this.checkedWidget,
...
class _RoundCheckBoxState extends State<fRoundCheckBox> {
  bool? isChecked;
  ...
  @override
  void didUpdateWidget(fRoundCheckBox oldWidget) {
    uncheckedColor =
